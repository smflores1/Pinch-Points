...
int main()
{
	...
	in_stream1.open("HexFkQ2PinchPoints12_34_56.txt"); //change name to your input file
	out_stream.open("HexFkQ2PinchPoints12_34_56Scaled.txt"); //change name to your output file
	...
	in_stream1.open("HexFkQ2PinchPoints12_34_56.txt"); //change name to your input file
	out_stream.open("HexFkQ2PinchPoints12_34_56Scaled.txt"); //change name to your ouput file
